...
function useRentalForm(companyId, userId) {
    ...
    const handleChange = (key, value)=>{
        setFormData((prev)=>{
            ...
            // ✅ Nếu nhập số điện thoại, kiểm tra khách hàng
            if (key === 'phone') {
                const trimmedPhone = value.trim();
                if (trimmedPhone.length >= 9) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$customers$2f$customerService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkCustomerByPhone"])(trimmedPhone).then((customer)=>{
                        if (customer) {
                            setFormData((current)=>({
                                    ...current,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b52f6b0c._.js.map