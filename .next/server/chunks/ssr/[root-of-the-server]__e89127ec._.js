...
function useRentalForm(companyId, userId) {
    ...
    // (Viết hàm load gói thuê ở đây sau cũng được nếu cần)
    }, [
        companyId
    ]);
...
function DynamicRentalFieldRenderer({ field, formData, handleChange, bikeSuggestions, populateVehicleSuggestions, handleSelectBike, companyId }) {
    ...
    // Các field đặc biệt ID / Search / Battery / Package...
    // (... copy phần đặc biệt từ DynamicRentalForm hiện tại)
    switch(field.type){
        case 'text':
        case 'number':
        case 'date':
...
function DynamicRentalForm({ companyId, userId }) {
    ...
    const { formData, handleChange, handleSubmit, setFormData, setLoading, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$rent$2f$common$2f$useRentalForm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRentalForm"])(companyId, userId);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e89127ec._.js.map