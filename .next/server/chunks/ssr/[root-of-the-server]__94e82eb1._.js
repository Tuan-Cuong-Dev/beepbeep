...
(()=>{
    const e = new Error("Cannot find module '@/src/lib/utils/formatCurrency'");
...
function BookingManagementPage() {
    const { bookings, editingBooking, setEditingBooking, saveBooking, deleteBooking, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useBookingData$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBookingData"])();
    ...
    const pageSize = 20;
    const normalizedRole = role?.toLowerCase() ?? '';
    // 👉 Lọc bookings theo role, search, status
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94e82eb1._.js.map