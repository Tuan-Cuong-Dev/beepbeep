...
function useCompanyAndStation() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const detect = async ()=>{
            setLoading(true);
            // 1. Ưu tiên companyId từ URL
            if (companyIdFromURL) {
                setCompanyId(companyIdFromURL);
                setLoading(false);
                return;
            }
            // 2. Nếu có sẵn companyId từ Auth (Company Owner, Private Provider) → dùng luôn
            if (companyIdFromAuth) {
                setCompanyId(companyIdFromAuth);
                setLoading(false);
                return;
            }
            // 3. Nếu role là staff hoặc technician → lấy từ staffs
            if (!user?.uid || ![
                "staff",
                "technician"
            ].includes(role || "")) {
...
function useVehicleIssues(companyId, userId, role) {
    ...
    async function fetchIssues() {
        ...
        let q;
        if (role === "technician") {
            // Technician chỉ xem lỗi chưa ai nhận hoặc đã được assign cho mình
...
function useVehicleIssues(companyId, userId, role) {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!companyId && role !== "technician") return;
        const fetchIssues = async ()=>{
            setLoading(true);
            try {
                let q;
                // Company Owner, Staff → lấy theo công ty
                if (role === "company_owner" || role === "staff" || role === "station_manager" || role === "support") {
                    q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebaseConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], "vehicleIssues"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])("companyId", "==", companyId));
                ...
                const snap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])(q);
                const rawIssues = snap.docs.map((doc)=>({
                        id: doc.id,
                        ...doc.data()
                    }));
                // 🔥 Fetch ebikes
                ...
                ebikeSnap.docs.forEach((doc)=>{
                    ebikeMap.set(doc.id, doc.data());
                });
                // 🔥 Map issues + enrich with VIN and PlateNumber
                const extended = rawIssues.map((issue)=>{
                    const ebike = ebikeMap.get(issue.ebikeId);
                    return {
                        ...issue,
                        vin: issue.ebikeId,
...
var { g: global, __dirname } = __turbopack_context__;
{
// components/vehicleIssues/AssignTechnicianForm.tsx
__turbopack_context__.s({
...
;
;
function AssignTechnicianForm({ onAssign }) {
    const [techUserId, setTechUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-4",
        children: [
...
function VehicleIssuesPage() {
    ...
    // Loading khi chưa có user hoặc đang lấy company
    ...
    // Nếu là các role bình thường (staff, owner...) mà không có company → lỗi
    if (!companyId && role !== "technician") {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "text-center py-10",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "flex-1 p-6 space-y-6 max-w-6xl mx-auto",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15803d4a._.js.map