...
"[project]/src/lib/staff/inviteUserAsStaff.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$staff$2f$inviteUserAsStaff$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/staff/inviteUserAsStaff.ts [app-ssr] (ecmascript)");
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            if (editingStaff) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$staff$2f$inviteUserAsStaff$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["inviteUserAsStaff"])({
                    email: form.email,
                    companyId,
...
function useStaffData(companyId) {
    ...
    const fetchStaffs = async ()=>{
        setLoading(true);
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$staff$2f$staffService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllStaffs"])(companyId);
        setStaffs(data);
        setLoading(false);
    };
    const handleCreate = async (staff)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$staff$2f$staffService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createStaff"])({
            ...staff,
            accepted: false
        }); // 👈 mặc định khi tạo mới là chưa xác nhận
        fetchStaffs();
    };
...
function StaffPage() {
    ...
    const { staffs, loading: staffLoading, handleCreate, handleUpdate, handleDelete, fetchStaffs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useStaffData$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStaffData"])(companyId || '');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (companyId) {
            fetchStaffs();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3d34418._.js.map