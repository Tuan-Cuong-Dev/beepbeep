...
function DynamicRentalForm({ companyId, userId }) {
    ...
    const populateVehicleFields = async (searchValue)=>{
        try {
            const snap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebaseConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'ebikes'));
            const bikes = snap.docs.map((doc)=>({
                    id: doc.id,
                    ...doc.data()
                }));
            const matched = bikes.find((bike)=>bike.vehicleID?.toLowerCase().includes(searchValue.toLowerCase()) || bike.plateNumber?.toLowerCase().includes(searchValue.toLowerCase()));
            const suggestions = bikes.filter((bike)=>bike.vehicleID?.toLowerCase().includes(searchValue.toLowerCase()) || bike.plateNumber?.toLowerCase().includes(searchValue.toLowerCase()));
            setBikeSuggestions(suggestions);
            if (!matched) return;
            const modelSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebaseConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'ebikeModels', matched.modelId));
            const modelName = modelSnap.exists() ? modelSnap.data().name : '';
            handleChange('vehicleModel', modelName);
            handleChange('vehicleColor', matched.color || '');
            handleChange('vin', matched.vehicleID || '');
            handleChange('licensePlate', matched.plateNumber || '');
        } catch (err) {
            console.error('Error fetching vehicle info:', err);
        }
    };
    const handleSelectSuggestion = async (bike)=>{
    ...
    const renderField = (field)=>{
                ...
                children: [
                    ...
                    bikeSuggestions.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        ...
                        children: bikeSuggestions.map((bike)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                ...
                                onClick: ()=>handleSelectSuggestion(bike),
                                children: [
                                    bike.vehicleID,
                                    " - ",
        ...
        if (field.key === 'package') {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(PackageSelector, {
                value: formData[field.key] || '',
                onChange: (val)=>handleChange(field.key, val),
                companyId: companyId
            }, field.key, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__011ea7b3._.js.map