...
var { g: global, __dirname } = __turbopack_context__;
{
// ❌ File này chỉ export constant, không cần 'use client'
__turbopack_context__.s({
...
function useRentalForm(companyId, userId) {
    ...
    const recalculatePricing = (data)=>{
        const rentalDays = Number(data['rentalDays']) || 0;
        const basePrice = Number(data['basePrice']) || 0;
        const deposit = Number(data['deposit']) || 0;
        const batteryRentalFee = Number(data['batteryRentalFee']) || 0;
        if (rentalDays && (basePrice || batteryRentalFee)) {
            const totalAmount = rentalDays * (basePrice + batteryRentalFee);
            data['totalAmount'] = totalAmount;
            data['remainingBalance'] = totalAmount - deposit;
        } else {
            data['totalAmount'] = 0;
    ...
    const handleChange = (key, value)=>{
        setFormData((prev)=>{
            ...
            if ([
                ...
                updated[key] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$parseCurrencyString$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseCurrencyString"])(value);
            } else {
                updated[key] = value;
            }
...
function DynamicRentalFieldRenderer({ field, formData, handleChange, bikeSuggestions, populateVehicleSuggestions, handleSelectBike, companyId }) {
    ...
    // Fields related to money formatting
    if ([
        'basePrice',
        'deposit',
        'overageRate',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e4928f8._.js.map