...
const acceptStaffInvitation = async (invite)=>{
    ...
    if (!staffSnap.empty) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$staff$2f$staffService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStaff"])(staffDoc.id, {
            accepted: true,
            name: userInfo.name || '',
...
//📦 Tính năng đã có:
//fetchInvitations(): lấy các lời mời có userId hiện tại
//acceptInvitation(invite): cập nhật status + tạo staff mới
// rejectInvitation(inviteId): từ chối lời mời
__turbopack_context__.s({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e545d15._.js.map