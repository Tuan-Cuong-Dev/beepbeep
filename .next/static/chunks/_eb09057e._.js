...
"[project]/src/lib/rentalCompanies/getCompanyName.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebaseConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/firebaseConfig.ts [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebaseConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/firebaseConfig.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rentalCompanies$2f$getCompanyName$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/rentalCompanies/getCompanyName.tsx [app-client] (ecmascript)");
                ...
                "useSubscriptionPackages.useEffect.unsubscribe": async (snapshot)=>{
                    ...
                    await Promise.all(Array.from(companyIds).map({
                        "useSubscriptionPackages.useEffect.unsubscribe": async (id)=>{
                            const name = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rentalCompanies$2f$getCompanyName$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCompanyName"])(id);
                            newMap[id] = name;
                        }
                    }["useSubscriptionPackages.useEffect.unsubscribe"]));
...
function SubscriptionPackageForm({ companyId, editingPackage, onSave, onUpdate, onCancel }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubscriptionPackageForm.useEffect": ()=>{
            ...
            if (id) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rentalCompanies$2f$getCompanyName$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCompanyName"])(id).then(setCompanyName);
            }
        }
    }["SubscriptionPackageForm.useEffect"], [
        editingPackage,
...
function SubscriptionPackageTable({ packages, companyNameMap, onEdit, onDelete }) {
    ...
    const filteredPackages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SubscriptionPackageTable.useMemo[filteredPackages]": ()=>{
            const keyword = searchTerm.toLowerCase();
            const filtered = packages.filter({
                "SubscriptionPackageTable.useMemo[filteredPackages].filtered": (pkg)=>pkg.name.toLowerCase().includes(keyword)
            }["SubscriptionPackageTable.useMemo[filteredPackages].filtered"]);
            return filtered.sort({
                "SubscriptionPackageTable.useMemo[filteredPackages]": (a, b)=>{
...
_s(SubscriptionPackageTable, "q1i7Ohhdg7w6djfAChvef1QjYkM=");
...
function SubscriptionPackageManager() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubscriptionPackageManager.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rentalCompanies$2f$getCompanyName$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCompanyName"])(companyId).then(setCompanyName);
        }
    }["SubscriptionPackageManager.useEffect"], []);
...
//# sourceMappingURL=_eb09057e._.js.map