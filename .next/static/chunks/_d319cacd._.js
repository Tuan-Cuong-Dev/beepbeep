        ...
        "QRCodeScanner.useEffect": ()=>{
            if (videoRef.current) {
                const scanner = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qr$2d$scanner$2f$qr$2d$scanner$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](videoRef.current, {
                    "QRCodeScanner.useEffect": async (result)=>{
                        if (result?.data) {
                            ...
                            const bike = snapshot.docs.map({
                                "QRCodeScanner.useEffect.bike": (doc)=>({
                                        id: doc.id,
                                        ...doc.data()
                                    })
                            }["QRCodeScanner.useEffect.bike"]).find({
                                "QRCodeScanner.useEffect.bike": (b)=>b.vehicleID?.toLowerCase() === vehicleID.toLowerCase()
                            }["QRCodeScanner.useEffect.bike"]);
                            if (bike) {
                                onScanned(bike);
                            }
                        }
...
_s(QRCodeScanner, "xVFID70l9naPxzdjriH4kaj9O1w=");
_c = QRCodeScanner;
var _c;
...
_s(DynamicRentalForm, "DV8wOLJozXVgMCZFWrHwX2KUCHk=");
...
//# sourceMappingURL=_d319cacd._.js.map