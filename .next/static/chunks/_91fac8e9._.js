...
function useVehicleIssues(options) {
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useVehicleIssues.useEffect": ()=>{
            const loadTechnicians = {
                "useVehicleIssues.useEffect.loadTechnicians": async ()=>{
                    if (!isAdmin) return;
                    ...
                    snapshot.docs.forEach({
                        "useVehicleIssues.useEffect.loadTechnicians": (doc)=>{
                            const data = doc.data();
                            if ((data.role || '').toLowerCase() === 'technician') {
                                map[doc.id] = data.name || data.email || doc.id;
                            }
                        }
                    }["useVehicleIssues.useEffect.loadTechnicians"]);
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "useVehicleIssues.useEffect.unsubscribe": (snapshot)=>{
                    const fetchedIssues = snapshot.docs.map({
                        "useVehicleIssues.useEffect.unsubscribe.fetchedIssues": (doc)=>({
                                ...doc.data(),
                                id: doc.id
                            })
                    }["useVehicleIssues.useEffect.unsubscribe.fetchedIssues"]);
                    setRawIssues(fetchedIssues);
                    setLoading(false);
                }
            }["useVehicleIssues.useEffect.unsubscribe"], {
                "useVehicleIssues.useEffect.unsubscribe": (error)=>{
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useVehicleIssues.useEffect": ()=>{
            const processedIssues = rawIssues.map({
                "useVehicleIssues.useEffect.processedIssues": (issue)=>{
            ...
            }["useVehicleIssues.useEffect.processedIssues"]);
   ...
   */ const updateIssue = async (id, data)=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(issueRef, data);
        } catch (error) {
...
function TechnicianDashboard() {
    ...
    const { issues, handleUpdate, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useVehicleIssues$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVehicleIssues"])({
        companyId: companyId || '',
        role: role || ''
    });
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-4",
                        children: [
                            !filteredIssues.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            filteredIssues.map((issue)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TechnicianDashboard, "bNiFz2I5X/4YvoXuGP1AqNRKyIc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"],
...
//# sourceMappingURL=_91fac8e9._.js.map