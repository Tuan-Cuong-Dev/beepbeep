        ...
        setFormData((prev)=>{
            ...
            if (key === 'phone') {
                ...
                if (trimmedPhone.length >= 9) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$customers$2f$customerService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkCustomerByPhone"])(trimmedPhone).then((customer)=>{
                        if (customer) {
                            setFormData((current)=>({
                                    ...current,
...
//# sourceMappingURL=_be248dfc._.js.map