...
function SwitchBikeModal({ open, onClose, onConfirm }) {
    ...
    const { staffProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    const stationId = staffProfile?.stationId;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SwitchBikeModal.useEffect": ()=>{
            const fetchAvailableBikes = {
                "SwitchBikeModal.useEffect.fetchAvailableBikes": async ()=>{
                    if (!stationId) return;
                    ...
                    const list = snap.docs.map({
                        "SwitchBikeModal.useEffect.fetchAvailableBikes.list": (doc)=>{
                            const data = doc.data();
                            return {
                                id: doc.id,
                    ...
                    }["SwitchBikeModal.useEffect.fetchAvailableBikes.list"]);
                    setAvailableBikes(list);
                }
            }["SwitchBikeModal.useEffect.fetchAvailableBikes"];
...
_s(SwitchBikeModal, "QCNZfMdDv0H3THSYX+G8jBqQ2Vw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
    ];
});
...
function ReturnBikePage() {
    ...
    const formatDateTime = (dateStr, hourStr)=>{
        ...
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(full), 'dd/MM/yyyy HH:mm');
        } catch  {
            return '-';
        }
    };
...
//# sourceMappingURL=_6707f7b7._.js.map