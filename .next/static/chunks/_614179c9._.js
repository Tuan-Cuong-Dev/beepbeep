        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                            children: [
                                ...
                                showStationColumn && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                    className: "px-3 py-2 border",
                                    children: "Station"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/ebikes/EbikeTable.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                        children: ebikes.map((bike)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                className: "hover:bg-gray-50",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                    ...
                                    showStationColumn && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
...
function EbikeSearchImportExport({ ebikes, models, setEbikes, searchTerm, setSearchTerm, onPrintAll, companyId }) {
    ...
    const handleDeleteAll = async ()=>{
        setDeleting(true);
        if (isAdmin) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ebikes$2f$deleteEbikesByCompany$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteAllEbikes"])(); // Xóa tất cả ebike toàn hệ thống
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ebikes$2f$deleteEbikesByCompany$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteAllEbikesByCompany"])(companyId); // Xóa ebike theo công ty
        }
        setEbikes([]);
        setDeleting(false);
...
function useRentalStations(companyId) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRentalStations.useEffect": ()=>{
            if (!companyId) return;
            const fetch = {
                "useRentalStations.useEffect.fetch": async ()=>{
                    try {
                        ...
                        const list = snapshot.docs.map({
                            "useRentalStations.useEffect.fetch.list": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["useRentalStations.useEffect.fetch.list"]);
                        setStations(list);
                    } catch (err) {
            ...
            }["useRentalStations.useEffect.fetch"];
            fetch();
        }
    }["useRentalStations.useEffect"], [
        companyId
...
function EbikeManagementPage() {
    _s();
    const { companyId: rawCompanyId, stationId, loading: userLoading, role } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    const isAdmin = role === 'Admin';
    const companyId = rawCompanyId ?? '';
    const companyIdToUse = isAdmin ? '' : companyId;
    const { ebikes, setEbikes, ebikeModels } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useEbikeData$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEbikeData"])(companyIdToUse);
    const { stations, loading: stationsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useRentalStations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRentalStations"])(companyIdToUse);
    const ebikeModelForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useEbikeModel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEbikeModelForm"])(companyIdToUse, {
    ...
    const [refetchModels, setRefetchModels] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [dialog, setDialog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        open: false,
        type: 'info',
        title: '',
...
_s(EbikeManagementPage, "DcwaNglNAk/birpUwrb09C+dNeM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"],
...
//# sourceMappingURL=_614179c9._.js.map