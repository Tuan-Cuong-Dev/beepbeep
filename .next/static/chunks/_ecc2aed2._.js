...
function DynamicRentalForm({ companyId, userId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DynamicRentalForm.useEffect": ()=>{
            ...
            fetch();
            const fetchPackages = {
                "DynamicRentalForm.useEffect.fetchPackages": async ()=>{
                    ...
                    const data = snap.docs.map({
                        "DynamicRentalForm.useEffect.fetchPackages.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["DynamicRentalForm.useEffect.fetchPackages.data"]);
                    setPackages(data);
                }
            }["DynamicRentalForm.useEffect.fetchPackages"];
            fetchPackages();
        }
    }["DynamicRentalForm.useEffect"], [
        companyId
    ...
    const renderField = (field)=>{
        ...
        if (field.key === 'package') {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PackageSelector, {
                value: formData[field.key] || '',
                onChange: (val)=>handleChange(field.key, val),
                companyId: companyId
            }, field.key, false, {
...
_s(DynamicRentalForm, "avlgPma975PZzRe41f/w+YBjPFM=");
...
//# sourceMappingURL=_ecc2aed2._.js.map