...
function useStaffData(companyId) {
    ...
    const fetchStaffs = async ()=>{
        setLoading(true);
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$staff$2f$staffService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllStaffs"])(companyId);
        setStaffs(data);
        setLoading(false);
    };
...
function StaffPage() {
    ...
    const { staffs, loading: staffLoading, handleCreate, handleUpdate, handleDelete, fetchStaffs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useStaffData$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStaffData"])(companyId || '');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StaffPage.useEffect": ()=>{
            if (companyId) {
                fetchStaffs();
...
_s(StaffPage, "GfOc55GMNLZ2mFzsC8C4gWdN+lI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"],
...
//# sourceMappingURL=_7b117473._.js.map