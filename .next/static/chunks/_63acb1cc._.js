...
"[project]/app/my-business/programs/[programId]/participants/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProgramParticipantsPage() {
    ...
    const [agentMap, setAgentMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProgramParticipantsPage.useEffect": ()=>{
            if (!programId) return;
            const fetchData = {
                "ProgramParticipantsPage.useEffect.fetchData": async ()=>{
                    ...
                    const participantsList = snap.docs.map({
                        "ProgramParticipantsPage.useEffect.fetchData.participantsList": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["ProgramParticipantsPage.useEffect.fetchData.participantsList"]);
                    setParticipants(participantsList);
                    const agentIds = participantsList.filter({
                        "ProgramParticipantsPage.useEffect.fetchData.agentIds": (p)=>p.userRole === 'agent'
                    }["ProgramParticipantsPage.useEffect.fetchData.agentIds"]).map({
                        "ProgramParticipantsPage.useEffect.fetchData.agentIds": (p)=>p.userId
                    }["ProgramParticipantsPage.useEffect.fetchData.agentIds"]);
                    if (agentIds.length > 0) {
                        ...
                        const agents = agentsSnap.docs.map({
                            "ProgramParticipantsPage.useEffect.fetchData.agents": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["ProgramParticipantsPage.useEffect.fetchData.agents"]);
                        const map = agents.reduce({
                            "ProgramParticipantsPage.useEffect.fetchData.map": (acc, agent)=>{
                                acc[agent.ownerId] = agent;
                                return acc;
                            }
                        }["ProgramParticipantsPage.useEffect.fetchData.map"], {});
                        setAgentMap(map);
                    }
                }
            }["ProgramParticipantsPage.useEffect.fetchData"];
            fetchData();
        }
    }["ProgramParticipantsPage.useEffect"], [
        programId
...
_s(ProgramParticipantsPage, "PE9HFt7zEHZN4d8l1O0GAWzVGF0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = ProgramParticipantsPage;
var _c;
__turbopack_context__.k.register(_c, "ProgramParticipantsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_63acb1cc._.js.map