...
_s(useCompanyAndStation, "JQeZw8GiJfCS6+uSRGrovfpoutA=", false, function() {
    return [
...
_s(useVehicleIssues, "eEeZVL7NpcRhooFXbQZQAsnNc6c=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
                ...
                "useVehicleIssues.useEffect.fetchIssues": async ()=>{
                    ...
                    try {
                        ...
                        const rawIssues = snap.docs.map({
                            "useVehicleIssues.useEffect.fetchIssues.rawIssues": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["useVehicleIssues.useEffect.fetchIssues.rawIssues"]);
                        // 🔥 Fetch ebikes
                        ...
                        const extended = rawIssues.map({
                            "useVehicleIssues.useEffect.fetchIssues.extended": (issue)=>{
                        ...
                        }["useVehicleIssues.useEffect.fetchIssues.extended"]);
                        setIssues(extended);
                    } catch (err) {
...
function AssignTechnicianForm({ onAssign }) {
    _s();
    const [techUserId, setTechUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-4",
        children: [
...
_s(AssignTechnicianForm, "DKTXsLDEURVDLzFXzKzx4wh1lP8=");
...
//# sourceMappingURL=_6dab9484._.js.map