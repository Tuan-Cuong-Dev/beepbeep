...
function DynamicRentalForm({ companyId, userId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DynamicRentalForm.useEffect": ()=>{
            ...
            fetch();
            const fetchBatteryCodes = {
                "DynamicRentalForm.useEffect.fetchBatteryCodes": async ()=>{
                    const snap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebaseConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'batteries'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('status', '==', 'In Stock')));
                    const codes = snap.docs.map({
                        "DynamicRentalForm.useEffect.fetchBatteryCodes.codes": (doc)=>doc.data().batteryCode
                    }["DynamicRentalForm.useEffect.fetchBatteryCodes.codes"]).filter({
                        "DynamicRentalForm.useEffect.fetchBatteryCodes.codes": (code)=>typeof code === 'string'
                    }["DynamicRentalForm.useEffect.fetchBatteryCodes.codes"]);
                    setBatteryCodes(codes);
                }
            }["DynamicRentalForm.useEffect.fetchBatteryCodes"];
            fetchBatteryCodes();
            const fetchPackages = {
                "DynamicRentalForm.useEffect.fetchPackages": async ()=>{
                    ...
                    setPackages(data.filter({
                        "DynamicRentalForm.useEffect.fetchPackages": (pkg)=>typeof pkg.id === 'string' && typeof pkg.name === 'string'
    ...
    const renderField = (field)=>{
        ...
        if (field.key.startsWith('batteryCode')) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimpleSelect"], {
                options: batteryCodes.filter((code)=>typeof code === 'string').map((code)=>({
                        label: code,
                        value: code
                    })),
                value: formData[field.key] || '',
        ...
        if (field.key.startsWith('package')) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimpleSelect"], {
                options: packages.filter((pkg)=>typeof pkg.id === 'string' && typeof pkg.name === 'string').map((pkg)=>({
                        label: pkg.name,
                        value: pkg.id
                    })),
                value: formData[field.key] || '',
...
_s(DynamicRentalForm, "hZ1ThXo2BXApxkcT81Kwn0kBdYY=");
...
//# sourceMappingURL=_2493c42d._.js.map