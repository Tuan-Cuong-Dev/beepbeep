        ...
        reader.onload = async (event)=>{
            try {
                ...
                const imported = json.map((row, index)=>({
                        ...
                        exportDate: row['Export Date'] ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"].fromDate(new Date(row['Export Date'])) : undefined,
                ...
                for (const battery of imported){
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(batteryRef, battery, {
                        merge: true
                    });
                }
...
function useBatteryData() {
    ...
    const fetchAllBatteries = async ()=>{
        try {
            ...
            console.error('Error fetching all batteries:', err);
    ...
    const fetchBatteriesByStaff = async (userId)=>{
        try {
            ...
            console.error('Error fetching batteries by company:', err);
            setError('Failed to load batteries');
        } finally{
            setLoading(false);
        }
...
_s(BatteryManagementPage, "eUzlsDOwSUogXpT10Z5meIEYBSI=", false, function() {
    return [
...
//# sourceMappingURL=_719779e1._.js.map