...
function CustomersPage() {
    ...
    const confirmDelete = (id)=>{
        ...
        setDialog({
            ...
            onConfirm: async ()=>{
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$customers$2f$customerService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCustomer"])(id);
        ...
        "CustomersPage.useEffect": ()=>{
            const fetchData = {
                "CustomersPage.useEffect.fetchData": async ()=>{
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$customers$2f$customerService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllCustomers"])();
                    setCustomers(data);
                }
    ...
    const saveCustomer = async ()=>{
        try {
            if (editingCustomer) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$customers$2f$customerService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCustomer"])(editingCustomer.id, newCustomer);
                ...
                const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$customers$2f$customerService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCustomer"])(newCustomer);
                setCustomers([
                    ...customers,
                    created
                ]);
...
//# sourceMappingURL=_3332578e._.js.map