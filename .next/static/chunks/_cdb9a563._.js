...
function BatteryForm({ newBattery, setNewBattery, isUpdateMode, setIsUpdateMode, setBatteries, onNotify }) {
    ...
    const resetForm = ()=>{
        setNewBattery({
            ...
            exportDate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"].fromDate(new Date()),
            status: 'in_stock',
            notes: ''
        });
...
_s(BatteryForm, "Iz3ozxQ+abMaAIcGIvU8cKUcBeo=");
_c = BatteryForm;
var _c;
...
_s(BatterySearchImportExport, "tH7ZqRWPURESo63ektLodVlwGb0=");
...
//# sourceMappingURL=_cdb9a563._.js.map