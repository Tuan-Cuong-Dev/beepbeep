    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-800">
      ...
      <main className="flex-grow max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="mb-4 text-lg">
          At Workman, we value your privacy and data protection. We are committed to being transparent with how we handle your data.
        </p>
        <ul className="list-disc list-inside space-y-3 text-base leading-relaxed">
          ...
          <li>
            ...
            <span className="text-[#00d289] font-medium">support@workman.vn</span>.
          </li>
        </ul>
