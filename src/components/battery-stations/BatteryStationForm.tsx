...
export default function BatteryStationForm({ station, onSave, onCancel }: Props) {
  ...
  return (
    <div className="space-y-6 bg-white rounded-xl p-4 shadow-sm border max-w-4xl mx-auto">
      <h2 className="text-xl font-semibold text-gray-800">📍 Battery Station Form</h2>
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-2">
        ...
        <Button onClick={handleSubmit} className="bg-[#00d289] hover:bg-[#00b67a] text-white">
          Save
        </Button>
      </div>
    </div>
