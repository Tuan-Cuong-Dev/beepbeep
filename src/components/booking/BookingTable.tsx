            ...
            .map((b) => (
              <tr key={b.id} className="hover:bg-gray-50">
                ...
                <td className="px-3 py-3 border align-top">
                  ...
                  <div className="text-xs text-gray-600">
                    {t('booking_table.package')}: {packageNames[b.package ?? ''] || 'N/A'}
                  </div>
                  <div className="text-xs text-gray-600">
                ...
                <td className="px-3 py-3 border align-top text-xs text-gray-600">
                  {b.userId ? userNames[b.userId] || t('booking_table.unknown_user') : <div className="italic text-gray-400">{t('booking_table.unknown')}</div>}
                </td>
                <td className="px-3 py-3 border align-top text-xs text-gray-600">
                ...
                <td className="px-3 py-3 border align-top text-xs text-gray-700 whitespace-pre-wrap">
                  {b.statusComment || <span className="italic text-gray-400">{t('booking_table.no_comment')}</span>}
                </td>
                <td className="px-3 py-3 border align-top">
                  <div className="flex flex-col gap-2">
                    <Button size="sm" onClick={() => onEdit(b)} className="bg-[#00d289] hover:bg-green-600 text-white">
