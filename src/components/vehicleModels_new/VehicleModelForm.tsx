...
import { VehicleModel, VehicleType, FuelType } from '@/src/lib/vehicleModels/vehicleModelTypes_new';
import { VEHICLE_SUB_TYPES } from '@/src/lib/vehicleModels/vehicleSubTypes';
